...
You can then execute your native executable with: `./build/micro-front-ends-1.0.0-SNAPSHOT-runner`
...
- Web Bundler - Svelte ([guide](https://docs.quarkiverse.io/quarkus-web-bundler/dev/integrations.html#svelte)): Add support for bundling with Svelte
...
This is a tiny app `index.html` to get started with the Web Bundler. Once the quarkus app is started visit the generated page at http://localhost:8080/web-bundler.html
